...
#                    ooo
                    ...
                    imgcored=filename[0:endnumslice]+'_'+str(scanNumber)+'.'+typeid 
...
#                                        recpo = cv2.imread(nampa,cv2.IMREAD_ANYDEPTH)
#                                        tarec=np.array(recpo)
#                                        min_val=np.min(tarec)
#                                        max_val=np.max(tarec) 
#                                        print 'Image recup', min_val, max_val
...
#                                        print 'tabi2',tabi2.min(),tabi2.max()
...
#                                        min_val=np.min(tarec)
#                                        max_val=np.max(tarec) 
#                                        print 'Image recup norm', min_val, max_val
#                                        ooo
...
#                     min_val=np.min(origbmp)
#                     max_val=np.max(origbmp)
